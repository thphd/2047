...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("lisp",function(){"use strict";return function(e){
...
contains:[b,e.SHEBANG(),s,g,l,o,u,m,c]}}}());hljs.registerLanguage("haskell",function(){"use strict";return function(e){
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}}());hljs.registerLanguage("less",function(){"use strict";return function(e){
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}}());hljs.registerLanguage("julia",function(){"use strict";return function(e){
...
}],n.contains=a.contains,a}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("r",function(){"use strict";return function(e){
...
begin:"%",end:"%"},{begin:"`",end:"`",contains:[{begin:/\\./}]}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,s]}}]}}}());hljs.registerLanguage("apache",function(){"use strict";return function(e){
...
}],illegal:/\S/}}}());hljs.registerLanguage("c",function(){"use strict";return function(e){
var n=e.requireLanguage("c-like").rawDefinition()
;return n.name="C",n.aliases=["c","h"],n}}());hljs.registerLanguage("properties",function(){"use strict";return function(e){
...
relevance:0}],starts:r},{className:"attr",relevance:0,begin:s+n+"$"}]}}}());hljs.registerLanguage("scss",function(){"use strict";return function(e){
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}}());hljs.registerLanguage("latex",function(){"use strict";return function(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
contains:[e.UNDERSCORE_TITLE_MODE]},{begin:"=>"},l,s]}}}());hljs.registerLanguage("diff",function(){"use strict";return function(e){return{
...
end:"$"}]}}}());hljs.registerLanguage("lua",function(){"use strict";return function(e){
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("coffeescript",function(){"use strict"
...
relevance:0}]}}}());hljs.registerLanguage("sql",function(){"use strict";return function(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("rust",function(){"use strict";return function(e){
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}}());hljs.registerLanguage("markdown",function(){"use strict";return function(n){
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}}());hljs.registerLanguage("css",function(){"use strict";return function(e){var n={
...
begin:"{",end:"}",illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("http",function(){"use strict";return function(e){
...
relevance:0}},{begin:"\\n\\n",starts:{subLanguage:[],endsWithParent:!0}}]}}}());hljs.registerLanguage("plaintext",function(){"use strict";return function(t){
return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}}());hljs.registerLanguage("objectivec",function(){"use strict";return function(e){
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}}());hljs.registerLanguage("perl",function(){"use strict";return function(e){var n={
$pattern:/[\w.]+/,
...
contains:a}}}());hljs.registerLanguage("php-template",function(){"use strict";return function(n){
...
contains:null,skip:!0})]}]}}}());hljs.registerLanguage("typescript",function(){"use strict"
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("swift",function(){"use strict";return function(e){var i={
...
},{beginKeywords:"import",end:/$/,contains:[e.C_LINE_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
